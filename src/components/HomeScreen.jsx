    ...
    <div className="relative flex size-full min-h-screen flex-col bg-white justify-between group/design-root overflow-x-hidden" style={{ fontFamily: 'Manrope, "Noto Sans", sans-serif' }}>
      ...
      <footer>
        <div className="flex gap-2 border-t border-[#f0f2f4] bg-white px-4 pb-3 pt-2">
          {[
            { icon: 'House', text: 'Home', color: '#111418' },
            { icon: 'Wrench', text: 'Services', color: '#637588' },
            { icon: 'CreditCard', text: 'Wallet', color: '#637588' },
            { icon: 'UserCircle', text: 'Profile', color: '#637588' },
          ].map((link, index) => (
            <a key={index} className={`flex flex-1 flex-col items-center justify-end gap-1 rounded-full text-${link.color}`} href="#">
