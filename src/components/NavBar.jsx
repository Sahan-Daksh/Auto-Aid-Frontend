...
//             { icon: 'Wrench', text: 'Services', color: '#637588', linkdir: '/services' },
//             { icon: 'CreditCard', text: 'Wallet', color: '#637588', linkdir: '/wallet' },
//             { icon: 'UserCircle', text: 'Profile', color: '#637588', linkdir: '/UserProfile2' },
//           ].map((link, index) => (
//             <Link 
//               key={index} 
