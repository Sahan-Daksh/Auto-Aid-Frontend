    ...
    >
      <div>
        <div className="flex items-center bg-[#faf8fc] p-4 pb-2 justify-between">
          ...
          <h2 className="text-[#140e1b] text-lg font-bold leading-tight tracking-[-0.015em] flex-1 text-center">
            Profile
          </h2>
        ...
        <div className="w-full min-h-[calc(100vh_-_100px)] relative flex flex-col justify-between p-6 bg-white">
          ...
          <div className="text-center mt-8">
            ...
            <p className="text-sm text-[#7e7e7e]">Web Developer</p>
          </div>
        </div>
      </div>
    </div>
